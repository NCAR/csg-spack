...
class IntelOneapiInspector(IntelOneApiLibraryPackageWithSdk):
    ...
    version(
        "2024.2.0",
        url="https://registrationcenter-download.intel.com/akdlm/IRC_NAS/1549c5b3-cf23-4595-9593-b5d0460a8dcd/l_inspector_oneapi_p_2024.2.0.22_offline.sh",
        sha256="e2aab9b1b428d0c23184beae8caac55fa3d3f973ac51a6b6908eb38b0d9097ed",
        expand=False,
    )
    version(
        "2024.1.0",
